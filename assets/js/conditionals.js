...
// console.log(currentMonth);
    ...
    if (currentMonth === 11) {
        ...
        document.querySelector("button.seasonal-button p").innerText = 'Christmas Theme';
        ...
        document.querySelector("button.seasonal-button p").innerText = "New Year's Theme";
        ...
        document.querySelector("button.seasonal-button p").innerText = "Valentine's Day Theme";
        ...
        document.querySelector("button.seasonal-button p").innerText = 'Spring Theme';
        ...
        document.querySelector("button.seasonal-button p").innerText = 'Summer Theme';
        ...
        document.querySelector("button.seasonal-button p").innerText = 'Autumn Theme';
        ...
        document.querySelector("button.seasonal-button p").innerText = 'Winter Theme';
