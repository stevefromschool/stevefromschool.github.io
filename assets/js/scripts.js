...
var currentMonth = new Date().getMonth();
    ...
    if (currentMonth === 11) {
        ...
        document.querySelector("button.seasonal-button span").innerText = 'Christmas Seasonal Theme';
        ...
        document.querySelector("button.seasonal-button span").innerText = "New Year's Seasonal Theme";
        ...
        document.querySelector("button.seasonal-button span").innerText = 'Spring Seasonal Theme';
        ...
        document.querySelector("button.seasonal-button span").innerText = 'Summer Seasonal Theme';
        ...
        document.querySelector("button.seasonal-button span").innerText = 'Autumn Seasonal Theme';
        ...
        document.querySelector("button.seasonal-button span").innerText = 'Winter Seasonal Theme';
